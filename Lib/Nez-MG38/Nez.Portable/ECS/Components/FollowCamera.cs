...
namespace Nez
{
	...
	public class FollowCamera : Component, IUpdatable
	{
		...
		private Vector2 _entitySize = Vector2.Zero;
		...
		public FollowCamera(Entity targetEntity, Vector2 entitySize, CameraStyle cameraStyle = CameraStyle.LockOn, Measurement deadzoneMeasurement = Measurement.FixedPixel) 
