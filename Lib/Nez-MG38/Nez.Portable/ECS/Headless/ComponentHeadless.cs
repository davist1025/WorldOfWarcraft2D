...
{
	public class ComponentHeadless
	{
		/// <summary>
		/// the Entity this Component is attached to
		/// </summary>
		public EntityHeadless Entity;

		/// <summary>
		/// shortcut to entity.transform
		/// </summary>
		/// <value>The transform.</value>
		public TransformHeadless Transform
		{
		...
		/// entity moving.
		/// </summary>
		public virtual void OnEntityTransformChanged(TransformHeadless.Component comp)
		{ }
		...
		public ComponentHeadless SetEnabled(bool isEnabled)
		{
		...
		public ComponentHeadless SetUpdateOrder(int updateOrder)
		{
		...
		/// </summary>
		public virtual ComponentHeadless Clone()
		{
			var component = MemberwiseClone() as ComponentHeadless;
			component.Entity = null;

			return component;
		}

		public int CompareTo(ComponentHeadless other) => _updateOrder.CompareTo(other._updateOrder);
