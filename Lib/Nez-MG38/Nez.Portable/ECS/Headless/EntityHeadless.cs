...
{
	public class EntityHeadless : IComparable<EntityHeadless>
	{
		...
		/// </summary>
		public readonly TransformHeadless Transform;

		/// <summary>
		/// list of all the components currently attached to this entity
		/// </summary>
		public readonly ComponentListHeadless Components;
		...
		public EntityHeadless(string name)
		{
			Components = new ComponentListHeadless(this);
			Transform = new TransformHeadless(this);
			Name = name;
			Id = _idGenerator++;
		}

		public EntityHeadless() : this(Utils.RandomString(8))
		{ }

		internal void OnTransformChanged(TransformHeadless.Component comp)
		{
		...
		public EntityHeadless SetTag(int tag)
		{
			if (_tag != tag)
			{
		...
		public EntityHeadless SetEnabled(bool isEnabled)
		{
		...
		public EntityHeadless SetUpdateOrder(int updateOrder)
		{
			if (_updateOrder != updateOrder)
			{
				_updateOrder = updateOrder;
				// todo: restore update order.
				//if (Scene != null)
				//{
		...
		/// </summary>
		public virtual EntityHeadless Clone(Vector2 position = default(Vector2))
		{
			var entity = Activator.CreateInstance(GetType()) as EntityHeadless;
		...
		protected void CopyFrom(EntityHeadless entity)
		{
			// Entity fields
			Tag = entity.Tag;
		...
		public T AddComponent<T>(T component) where T : ComponentHeadless
		{
		...
		/// <returns>Scene.</returns>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public T AddComponent<T>() where T : ComponentHeadless, new()
		{
			var component = new T();
			component.Entity = this;
			Components.Add(component);
		...
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public T GetComponent<T>() where T : ComponentHeadless => Components.GetComponent<T>(false);
		...
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public bool TryGetComponent<T>(out T component) where T : ComponentHeadless
		{
		...
		/// </summary>
		public bool HasComponent<T>() where T : ComponentHeadless => Components.GetComponent<T>(false) != null;
		...
		/// <returns>The component.</returns>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public T GetOrCreateComponent<T>() where T : ComponentHeadless, new()
		{
		...
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public T GetComponent<T>(bool onlyReturnInitializedComponents) where T : ComponentHeadless
		{
		...
		/// <returns>The component.</returns>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public List<T> GetComponents<T>() where T : ComponentHeadless => Components.GetComponents<T>();

		/// <summary>
		/// removes the first Component of type T from the components list
		/// </summary>
		public bool RemoveComponent<T>() where T : ComponentHeadless
		{
		...
		public void RemoveComponent(ComponentHeadless component) => Components.Remove(component);
		...
		public int CompareTo(EntityHeadless other)
		{
