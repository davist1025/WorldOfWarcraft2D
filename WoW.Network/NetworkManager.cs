...
namespace WoW.Network
{
    ...
    public enum PacketOpCode
    {
        ...
        // todo: send an unconnected message for realm transfer protocol?
    ...
    /// <summary>
    /// The shared network handler.
    /// 
    /// This can function as a client or server object, which would have a custom implementation of <see cref="INetEventListener"/>
    /// </summary>
